        ...
        <Card className="card" border="secondary">
          ...
          <Card.Body>
            <form>
              ...
              <input className="form-control" name="email" type="email" value={email} onChange={handleChange} placeholder="Enter Your Email" />
                <p className="error">{err}</p>
              </div>
              <div>
                <Button type="sumbit" variant="primary" onClick={handleSubmit}>Send</Button>
              </div>
